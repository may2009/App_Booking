...
<div class="section background-dark over-hide">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-10 col-sm-8 parallax-fade-top">
                    <div class="hero-text">Indiquez vos dates et faites votre choix ...</div>
                </div>
                ...
                <div class="col-12 mt-3 parallax-fade-top">
                    <div class="booking-hero-wrap">
                        <div class="row justify-content-center">
                            <div class="col-10 no-mob">
                                <div class="input-daterange input-group" id="flight-datepicker">
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-item">
                                                <span class="fontawesome-calendar"></span>
                                                <input class="input-sm" type="text" autocomplete="off" id="start-date-1" name="start" placeholder="Date Début" data-date-format="DD, MM d"/>
                                        ...
                                        <div class="col-4">
                                            <div class="form-item">
                                                <span class="fontawesome-calendar"></span>
                                                <input class="input-sm" type="text" autocomplete="off" id="end-date-1" name="end" placeholder="Date Fin" data-date-format="DD, MM d"/>
                                                <span class="date-text date-return"></span>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <select name="adults" class="wide">
                                                <option data-display="Nombre du personnel">Nombre du personnel</option>
                            ...
                            <div class="col-6  col-sm-4 col-lg-2">
                                <a class="booking-button" href="search.html">Réserver</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="slideshow">
        <div class="slide slide--current parallax-top">
            <figure class="slide__figure">
                <div class="slide__figure-inner">
                    <div class="slide__figure-img" style="background-image: url(/assets_user/img/1.jpg)"></div>
        ...
        <div class="slide parallax-top">
            <figure class="slide__figure">
                <div class="slide__figure-inner">
                    <div class="slide__figure-img" style="background-image: url(/assets_user/img/2.jpg)"></div>
                    <div class="slide__figure-reveal"></div>
                </div>
            </figure>
        </div>
        <div class="slide parallax-top">
            <figure class="slide__figure">
                <div class="slide__figure-inner">
                    <div class="slide__figure-img" style="background-image: url(/assets_user/img/3.jpg)"></div>
                    <div class="slide__figure-reveal"></div>
                </div>
            </figure>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 mt-4 mt-md-0">
                <div class="img-wrap">
                    <img src="/assets_user/img/rooms.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row mx-0">
            <div class="col-xl-6 px-0">
                <div class="img-wrap" id="rev-1">
                    <img src="/assets_user/img/room1.jpg" alt="">
        ...
        <div class="row mx-0">
            ...
            <div class="col-xl-6 px-0 order-first order-xl-last mt-5 mt-xl-0">
                <div class="img-wrap" id="rev-2">
                    <img src="/assets_user/img/room2.jpg" alt="">
    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-sm-6 col-lg-3">
                <a href="services.html">
                    <div class="img-wrap services-wrap">
                        <img src="/assets_user/img/ser-1.jpg" alt="">
            ...
            <div class="col-sm-6 col-lg-3 pt-4 pt-sm-0">
                <a href="services.html">
                    <div class="img-wrap services-wrap">
                        <img src="/assets_user/img/ser-2.jpg" alt="">
            ...
            <div class="col-sm-6 col-lg-3 pt-4 pt-lg-0">
                <a href="services.html">
                    <div class="img-wrap services-wrap">
                        <img src="/assets_user/img/ser-3.jpg" alt="">
            ...
            <div class="col-sm-6 col-lg-3 pt-4 pt-lg-0">
                <a href="services.html">
                    <div class="img-wrap services-wrap">
                        <img src="/assets_user/img/ser-4.jpg" alt="">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-sm-6 col-lg-4">
                <div class="services-box text-center">
                    <img src="/assets_user/img/1.svg" alt="">
            ...
            <div class="col-sm-6 col-lg-4 mt-5 mt-sm-0">
                <div class="services-box text-center">
                    <img src="/assets_user/img/2.svg" alt="">
            ...
            <div class="col-sm-6 col-lg-4 mt-5 mt-lg-0">
                <div class="services-box text-center">
                    <img src="/assets_user/img/3.svg" alt="">
            ...
            <div class="col-sm-6 col-lg-4 mt-5">
                <div class="services-box text-center">
                    <img src="/assets_user/img/4.svg" alt="">
            ...
            <div class="col-sm-6 col-lg-4 mt-5">
                <div class="services-box text-center">
                    <img src="/assets_user/img/5.svg" alt="">
            ...
            <div class="col-sm-6 col-lg-4 mt-5">
                <div class="services-box text-center">
                    <img src="/assets_user/img/6.svg" alt="">
...
<div class="section padding-top-bottom-big over-hide">
    <div class="parallax" style="background-image: url('/assets_user/img/4.jpg')"></div>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6">
                <div class="room-box background-white">
                    ...
                    <img src="/assets_user/img/room3.jpg" alt="">
            ...
            <div class="col-md-6 mt-4 mt-md-0">
                <div class="room-box background-white">
                    ...
                    <img src="/assets_user/img/room4.jpg" alt="">
                    <div class="room-box-in">
            ...
            <div class="col-md-6 mt-4">
                <div class="room-box background-white">
                    ...
                    <img src="/assets_user/img/room5.jpg" alt="">
                    <div class="room-box-in">
            ...
            <div class="col-md-6 mt-4">
                <div class="room-box background-white">
                    ...
                    <img src="/assets_user/img/room6.jpg" alt="">
                    <div class="room-box-in">
...
<div class="section padding-top-bottom-big over-hide">
    <div class="parallax" style="background-image: url('/assets_user/img/5.jpg')"></div>
    <div class="section z-bigger">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
        ...
        <div class="row background-white p-0 m-0">
            <div class="col-xl-6 p-0">
                <div class="img-wrap" id="rev-3">
                    <img src="/assets_user/img/rest-1.jpg" alt="">
                </div>
            </div>
        ...
        <div class="row background-white p-0 m-0">
            ...
            <div class="col-xl-6 order-first order-xl-last p-0">
                <div class="img-wrap" id="rev-4">
                    <img src="/assets_user/img/rest-2.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
...
<div class="section">
    <div id="owl-sep-2" class="owl-carousel owl-theme">
        <div class="item">
            <a href="/assets_user/img/gallery/1.jpg" data-fancybox="gallery">
                <div class="img-wrap gallery-small">
                    <img src="/assets_user/img/gallery/1-s.jpg" alt="">
                </div>
            </a>
        </div>
        <div class="item">
            <a href="/assets_user/img/gallery/2.jpg" data-fancybox="gallery">
                <div class="img-wrap gallery-small">
                    <img src="/assets_user/img/gallery/2-s.jpg" alt="">
                </div>
            </a>
        </div>
        <div class="item">
            <a href="/assets_user/img/gallery/3.jpg" data-fancybox="gallery">
                <div class="img-wrap gallery-small">
                    <img src="/assets_user/img/gallery/3-s.jpg" alt="">
                </div>
            </a>
        </div>
        <div class="item">
            <a href="/assets_user/img/gallery/4.jpg" data-fancybox="gallery">
                <div class="img-wrap gallery-small">
                    <img src="/assets_user/img/gallery/4-s.jpg" alt="">
                </div>
            </a>
        </div>
        <div class="item">
            <a href="/assets_user/img/gallery/5.jpg" data-fancybox="gallery">
                <div class="img-wrap gallery-small">
                    <img src="/assets_user/img/gallery/5-s.jpg" alt="">
                </div>
            </a>
        </div>
        <div class="item">
            <a href="/assets_user/img/gallery/6.jpg" data-fancybox="gallery">
                <div class="img-wrap gallery-small">
                    <img src="/assets_user/img/gallery/6-s.jpg" alt="">
                </div>
            </a>
        </div>
        <div class="item">
            <a href="/assets_user/img/gallery/7.jpg" data-fancybox="gallery">
                <div class="img-wrap gallery-small">
                    <img src="/assets_user/img/gallery/7-s.jpg" alt="">
                </div>
            </a>
        </div>
        <div class="item">
            <a href="/assets_user/img/gallery/8.jpg" data-fancybox="gallery">
                <div class="img-wrap gallery-small">
                    <img src="/assets_user/img/gallery/8-s.jpg" alt="">
                </div>
            </a>
        </div>
        <div class="item">
            <a href="/assets_user/img/gallery/9.jpg" data-fancybox="gallery">
                <div class="img-wrap gallery-small">
                    <img src="/assets_user/img/gallery/9-s.jpg" alt="">
                </div>
            </a>
        </div>
        <div class="item">
            <a href="/assets_user/img/gallery/10.jpg" data-fancybox="gallery">
                <div class="img-wrap gallery-small">
                    <img src="/assets_user/img/gallery/10-s.jpg" alt="">
                </div>
            </a>
        </div>
        <div class="item">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5 mt-4 mt-md-0 text-center text-md-left logos-footer">
                ...
                <img src="/assets_user/img/logos/1.png" alt="">
                <img src="/assets_user/img/logos/2.png" alt="">
                <img src="/assets_user/img/logos/3.png" alt="">
            </div>
        </div>
    </div>
</div>
